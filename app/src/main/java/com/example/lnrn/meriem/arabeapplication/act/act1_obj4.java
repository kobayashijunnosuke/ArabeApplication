...
public class act1_obj4 extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View rootview = inflater.inflate(R.layout.fragment_act1_obj4, container, false);
        ...
        consigne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp = MediaPlayer.create(rootview.getContext(),R.raw.quest1_obj4);
                mp.start();
            }
        });
