...
public class act1_obj3 extends Fragment {

    public act1_obj3() {
        // Required empty public constructor
    }
    CheckBox txt1,txt2,txt3,txt4,txt5,txt6;
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View rootview= inflater.inflate(R.layout.fragment_act1_obj3, container, false);
        ...
        txt5=(CheckBox)rootview.findViewById(R.id.mots5);
        txt6=(CheckBox)rootview.findViewById(R.id.mots6);
        ...
        setfl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(txt1.isChecked() && txt4.isChecked() && txt5.isChecked()&& !txt2.isChecked() && !txt3.isChecked()&& !txt6.isChecked()){
                    checkanswer();
                    Fragment fg = new act2_obj3();
                    ...
                    if(essay<3){
                        ...
                        txt5.setChecked(false);
                        txt6.setChecked(false);
                        essay=essay+1;
                    }
                    else {
                        Fragment fg = new act2_obj3();
...
//sound consigne :
        ...
        consigne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(rootview.getContext(),R.raw.quest1_obj3);
                mp.start();
            }
        });
