...
public class act2_obj4 extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View rootview = inflater.inflate(R.layout.fragment_act2_obj4, container, false);
        ...
        target=(ImageView)rootview.findViewById(R.id.book);
        ...
        consigne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mp = MediaPlayer.create(rootview.getContext(),R.raw.quest2_obj4);
                mp.start();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if(i==1) {
                    ...
                    if(essay<3){
                        ...
                        mp.start();
                        a.show();
                        new_image = getResources().getDrawable(R.drawable.book);
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (dragEvent){
                ...
                case DragEvent.ACTION_DROP:
                    if(view.getId()== R.id.mots1){
                        new_image = getResources().getDrawable(R.drawable.book_open);
                        target.setImageDrawable(new_image);
                        i=1;
