...
public class act3_obj2 extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View rootview=inflater.inflate(R.layout.fragment_act3_obj2, container, false);
        ...
        setfl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(txt1.isChecked() && txt3.isChecked()){
                    checkanswer();
        ...
        consigne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(rootview.getContext(),R.raw.quest3_obj2);
                mp.start();
            }
        });

        checkclick(txt1,rootview.getContext(),R.raw.qossor);
        checkclick(txt2,rootview.getContext(),R.raw.fodol);
        checkclick(txt3,rootview.getContext(),R.raw.soror);
