...
public class act_obj9 extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View rootview=inflater.inflate(R.layout.fragment_act_obj9, container, false);
       ...
       // check();
        ...
        consigne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(rootview.getContext(),R.raw.quest_obj9);
                mp.start();
            }
        });
