...
public class act2_obj5 extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View rootview=inflater.inflate(R.layout.fragment_act2_obj5, container, false);
        ...
        consigne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(rootview.getContext(),R.raw.quest2_obj5);
                mp.start();
            }
        });

        //sound image :
        mots=(ImageView) rootview.findViewById(R.id.son);
        checkclick(mots,rootview.getContext(),R.raw.falafil);
...
//next
    ...
    public void checkclick(ImageView a, final Context sound, final int src){
