...
public class act1_obj5 extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View rootview=inflater.inflate(R.layout.fragment_act1_obj5, container, false);
        ...
        consigne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mp = MediaPlayer.create(rootview.getContext(),R.raw.quest1_obj5);
                mp.start();
            }
        });

        checkclick(txt1,rootview.getContext(),R.raw.qassr);
        checkclick(txt2,rootview.getContext(),R.raw.qassir);
        checkclick(txt3,rootview.getContext(),R.raw.qitar);
